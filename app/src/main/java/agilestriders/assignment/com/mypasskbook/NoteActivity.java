...
public class NoteActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        //On back press in appbar to go back to previous screen.
    ...
    private void actionCancel() {
        ...
        if(!checkNoteAltred()) { //if note is not altered by user (user only viewed the note/or did not write anything)
            finish(); //just exit the activity and go back to AlarmActivity
    ...
    /**
     * Validate the title and content and save the note and finally exit the activity and go back to AlarmActivity
     */
    private void validateAndSaveNote() {
        ...
        finish(); //exit the activity, should return us to AlarmActivity
    }
}
